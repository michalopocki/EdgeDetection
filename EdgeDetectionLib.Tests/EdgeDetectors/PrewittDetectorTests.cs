...
{
    public class PrewittDetectorTests
    {
        private readonly PrewittDetector _sut;
        public PrewittDetectorTests()
        {
            var mock = new Mock<IGradientArgs>();
            _sut = new PrewittDetector(mock.Object);
        }

        [Fact]
        public void PropertyName_ShouldBe_Roberts()
        {
            string expected = "Prewitt";
        ...
        public void DetectEdges_ShouldReturnEdgeDetectionResult()
        {
            ...
            var detector = new PrewittDetector(mock.Object);
