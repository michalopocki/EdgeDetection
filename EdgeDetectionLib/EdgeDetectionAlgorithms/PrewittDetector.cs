...
{
    /// <summary>
    /// Class that enables edge detection in an image utilising Prewitt operator.
    /// </summary>
    public class PrewittDetector : GradientDetectorBase
    {
        ...
        /// <summary> Prewitt operator horizontal kernel. </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PrewittDetector"/> class.
        /// </summary>
        /// <param name="args">
        ...
        /// <summary>
        /// Detects edges in an image utilising Prewitt operator.
        /// </summary>
        /// <returns>
