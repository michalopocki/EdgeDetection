...
namespace EdgeDetectionLib.EdgeDetectionAlgorithms.InputArgs.ArgsBuilders
{
    ...
    {
        private CannyArgs _cannyArgs = new CannyArgs(null, false, false, 0, 0, 0, 0);
        ...
        public CannyArgsBuilder SetGrayscale(bool isGrayscale)
        {
            _cannyArgs.IsGrayscale = isGrayscale;
            return this;
        }
